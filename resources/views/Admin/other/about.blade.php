...
@section('page_subtitle', 'Kelola konten halaman Tentang yang ditampilkan ke publik')
...
<div class="max-w-4xl">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h2 class="text-lg font-bold text-slate-900">Tentang</h2>
            <p class="text-[0.82rem] text-slate-500">Konten ini tampil di halaman publik <span class="font-semibold text-slate-700">/tentang</span></p>
        </div>
    ...
    {{-- Form --}}
    <form method="POST" action="{{ route('admin.other.about.update') }}">
        @csrf @method('PUT')
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div class="flex items-center gap-2 px-5 py-3 border-b border-slate-100"
                ...
                <svg class="w-3.5 h-3.5 shrink-0" style="color:#b45309;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
                <p class="text-[0.75rem] text-amber-800">
                    Anda dapat menggunakan format <strong>HTML</strong> seperti
                    <code class="bg-amber-100 px-1 rounded text-[0.72rem]">&lt;b&gt;</code>,
                    <code class="bg-amber-100 px-1 rounded text-[0.72rem]">&lt;p&gt;</code>,
                    <code class="bg-amber-100 px-1 rounded text-[0.72rem]">&lt;ul&gt;</code>, dll.
                    — atau tulis biasa saja, konten akan ditampilkan apa adanya.
                </p>
            </div>
            ...
            <div class="p-5">
                <textarea
                    ...
                    id="aboutContent"
                    rows="22"
                    placeholder="Tulis konten halaman Tentang di sini...&#10;&#10;Contoh:&#10;Penginapan kami berdiri sejak tahun 2010 dan berkomitmen memberikan pelayanan terbaik untuk setiap tamu..."
                ...
                >{{ old('about', $other->about) }}</textarea>
                ...
                <div class="mt-5 pt-5 border-t border-slate-100">
                    <label class="flex items-center gap-2 text-[0.82rem] font-semibold text-slate-700 mb-2" for="aboutEnContent">
                    ...
                    <textarea
                        ...
                        id="aboutEnContent"
                        rows="18"
                        placeholder="Write the About page content in English here...&#10;&#10;Example:&#10;Our accommodation has been in operation since 2010, committed to providing the best service for every guest..."
                        class="w-full px-4 py-3.5 rounded-xl border border-slate-200 bg-slate-50
                               text-[0.875rem] text-slate-800 leading-relaxed resize-y
                               focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100
                               transition-colors"
                        style="min-height: 320px; font-family: 'Inter', monospace;"
                    >{{ old('about_en', $other->about_en) }}</textarea>
                    @error('about_en')
...
// Update preview realtime jika sudah terbuka
