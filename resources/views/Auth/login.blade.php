...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .btn-main:hover  { background: var(--btn-primary-hover); }
...
<body style="min-height:100vh; display:flex; background:#f1f5f9;">
                                ...
                                <div style="display:flex;gap:0.375rem;flex:1;">
                                    <input
                                        ...
                                        onfocus="this.style.borderColor='var(--color-primary)';
                                                 this.style.boxShadow='0 0 0 3px rgba(var(--color-primary-rgb),0.12)'"
                                    ...
                                    <button type="button" onclick="refreshCaptcha()"
                                        ...
                                        onmouseover="this.style.borderColor='var(--color-primary)';this.style.background='#fff'"
    ...
    <script>
        ...
        (function() {
            ...
            function rgbToHsv(r,g,b){r/=255;g/=255;b/=255;var mx=Math.max(r,g,b),mn=Math.min(r,g,b),d=mx-mn,hh=0,ss=mx===0?0:d/mx;if(d>0){if(mx===r)hh=((g-b)/d)%6;else if(mx===g)hh=(b-r)/d+2;else hh=(r-g)/d+4;hh=hh*60;if(hh<0)hh+=360;}return[hh,ss,mx];}
            ...
            var v50=lighten(r,g,b,0.93),v100=lighten(r,g,b,0.85);
            var hsv=rgbToHsv(r,g,b),hh=hsv[0];
            ...
            root.style.setProperty('--color-primary-50',toHex(...v50));
