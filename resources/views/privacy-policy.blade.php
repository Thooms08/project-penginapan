...
<style>
    ...
    .other-hero-icon {
        ...
        flex-shrink: 0; background: #fce7f3;
    }
    .other-hero-title {
    ...
    .other-content a   { color: #9d174d; text-decoration: underline; }
...
<div class="other-wrap">
    ...
    <div class="other-hero">
        <div class="other-hero-icon">
            <svg class="w-6 h-6" style="color:#9d174d;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
