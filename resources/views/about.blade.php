...
<style>
    ...
    .other-hero-icon {
        ...
        flex-shrink: 0; background: #fef9c3;
    }
    .other-hero-title {
    ...
    .other-hero-sub {
        font-size: 0.82rem; color: #94a3b8; margin-top: 0.2rem;
    }
    ...
    @media (max-width: 640px) {
        .other-content { padding: 1.25rem 1.25rem; font-size: 0.875rem; }
    }
    ...
    .other-content ul,.other-content ol {
        padding-left: 1.5rem; margin-bottom: 0.9rem;
    }
    .other-content li  { margin-bottom: 0.3rem; }
    .other-content a   { color: #b45309; text-decoration: underline; }
...
<div class="other-wrap">
    ...
    <div class="other-hero">
        ...
        <div>
            <h1 class="other-hero-title">{{ __('visitor.about_us') }}</h1>
    ...
    <div class="other-content">
        @php $aboutContent = $other->trans('about'); @endphp
        @if($aboutContent)
            {!! $aboutContent !!}
        @else
